...
class DevConfig(BaseConfig):
	...
	DEBUG = TrueSQLALCHEMY_DATABSE_URI = 'postgresql://db_user:db_password@db-postgres:5432/flask-deploy'
...
class ProductionConfig(BaseConfig):
	...
	SQLALCHEMY_DATABSE_URI = 'postgresql://db_user:db_password@db-postgres:5432/flask-deploy'
	CELERY_BROKER = 'pyamqp://rabbit_user:rabbit_password@broker-rabbitmq//'
	CELERY_RESULT_BACKEND = 'rpc://rabbit_user:rabbit_password@broker-rabbitmq//'
